...
public $Blocks = [
  ...
  public $Mobs = [
    "ICON" => ["Mobs",52,0],
    "Sheep" => [383,13,130000,65000],
    "Pig" => [383,12,150000,75000],
    "Chicken" => [383,10,100000,50000],
    "Skeleton" => [383,34,200000,100000],
    "Zombie" => [383,32,250000,125000],
    "Husk" => [383,47,300000,150000],
    "Zombie_Pigman" => [383,36,400000,200000],
    "Iron_Goelm" => [383,20,500000,250000],
  ...
  public function sendMainShop(Player $player){
    $ui = new SimpleForm("§bOmicron§4Factions§cPE §dShop","       §aPurchase and Sell items Here!");
